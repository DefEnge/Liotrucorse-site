...
<footer class="lg:text-left">
  <div class="flex items-center justify-center border-b-2 border-neutral-200 p-6  lg:justify-between">
    ...
    <div class="flex justify-center">
      ...
      <a href="#!" class="mr-6 text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          <path
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className='text-white'>
        ...
        <p class=" text-sm mb-4 flex items-center justify-center md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
