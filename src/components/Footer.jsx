...
import Logo from '../assets/scudetto.svg';
...
<footer className="lg:text-left">
  <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6  lg:justify-between">
      <img src={Logo} className='h-[5%] w-[5%] mr-12' alt="" />
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid-1 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="text-white">
        ...
        <p className="mb-4">
          <a href="#/News" className="text-neutral-600 dark:text-neutral-200">News</a>
        </p>
        <p className="mb-4">
          <a href="#/Project" className="text-neutral-600 dark:text-neutral-200">Projects</a>
        </p>
        <p>
          <a href="#!" className="text-neutral-600 dark:text-neutral-200">Contacts</a>
        </p>
      </div>
      ...
      <div className='text-white'>
        ...
        <p className=" text-sm mb-4 flex items-center justify-center md:justify-start">
          <svg
            ...
            scuderialiotrucorse@liotrucorse.com
        </p>
      </div>
